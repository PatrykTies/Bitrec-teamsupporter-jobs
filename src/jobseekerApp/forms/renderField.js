  ...
  return(
      <div>
        ...
        <div style={{color: "red"}}>
          ...
          {(this.props.meta.dirty || this.props.meta.touched) && this.props.meta.error === "Input too long" ? <span>{this.context.t('Must not be longer than 15 letters')}</span> : ""}
