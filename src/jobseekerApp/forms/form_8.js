    ...
    return(
      <div>
        ...
        <div className='files-page-wrapper'>
          <h4 className='upload-title'>{this.context.t('Upload your resume (optional)')}</h4>
          <h4 className='pick-upload'>{this.context.t('Pick one of the upload options provided below')}</h4>
          <p className='file-types'>{this.context.t('Accepted file formats: .pdf, .doc, .txt, .rtf only.')}</p>
          <p className='file-size'>{this.context.t('Maximum allowed file size is 1MB.')}</p>
            <Field
              name="CV"
              type="text"
              component={Dropbox}
